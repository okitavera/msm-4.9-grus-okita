...
enum DISPPARAM_MASK {
    DISPPARAM_MODE_MASK = 0x0000000F,
    DISPPARAM_CE_MASK = 0x000000F0,
    DISPPARAM_DIMMING_MASK = 0x00000F00,
    DISPPARAM_ACL_MASK = 0x0000F000,
    DISPPARAM_HBM_MASK = 0x000F0000,
    DISPPARAM_CRC_MASK = 0x00F00000,
    DISPPARAM_BACKLIGHT_MASK = 0x0F000000,
};

enum DISPPARAM_MODE {
	DISPPARAM_WARM = 0x1,
	DISPPARAM_NORMAL = 0x2,
	DISPPARAM_COLD = 0x3,
